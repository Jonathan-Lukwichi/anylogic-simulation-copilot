...
| **Statistics / input distributions / goodness-of-fit** | `02-statistics-input-modeling/` + NIST e-Handbook (see SOURCES.md) | Fit properly (scipy.stats / fitdistrplus) + report KS/AD. Don't eyeball. |
| **Supply chain, inventory policy, network/distribution** | `03-supply-chain/` + Ivanov book (see SOURCES.md) | Simchi-Levi et al. is the textbook anchor — supply your own copy (see PRIVATE-MATERIALS.md). |
